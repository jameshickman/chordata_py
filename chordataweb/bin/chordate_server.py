...
from chordataweb.dispatcher import Dispatcher, RouteNotFound, build_route_map
from chordataweb.events import find_watchers
from chordataweb.cookies import get_cookies, build_cookie_header
...
SessionManager = injection_manager.get('chordataweb.implementations.session', 'SessionManager')
ResolveTenant = injection_manager.get('chordataweb.implementations.resolver', 'ResolveTenant')
